...
/**
 * @author Cyril ogoh <cyrilogoh@gmail.com>
 * @description Get User Profile Complete `Recruiter Account Only`
...
/**
 * @author Cyril ogoh <cyrilogoh@gmail.com>
 * @description Get User Notifications `Recruiter Account Only`
 * @route `/api/v1/recruiter/`
 * @access Private
 * @type GET
 */
...
/**
 * @author Cyril ogoh <cyrilogoh@gmail.com>
 * @description Update User `Recruiter Account Only`
 * @route `/api/v1/Recruiter/edit`
 * @access Private
 * @type PUT
 */
